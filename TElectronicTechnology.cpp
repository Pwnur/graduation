...
#include "ui_TElectronicTechnology.h"

TElectronicTechnology::TElectronicTechnology(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::TElectronicTechnology)
{
    ui->setupUi(this);
...
TElectronicTechnology::~TElectronicTechnology()
{
    delete ui;
}

bool TElectronicTechnology::judgeEmpty()
{
...
void TElectronicTechnology::ShowSupplyclick()
{
...
void TElectronicTechnology::comeTeacherManage(QString num)
{
...
void TElectronicTechnology::on_searchbtn_clicked()
{
...
void TElectronicTechnology::on_addbtn_clicked()
{
    if(!this->judgeEmpty())
        return;
    _model->select();
...
void TElectronicTechnology::on_changebtn_clicked()
{
    if(model->submitAll())
...
void TElectronicTechnology::on_deletebtn_clicked()
{
...
void TElectronicTechnology::on_returnbtn_clicked()
{
    this->hide();
