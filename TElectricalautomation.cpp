...
#include "ui_TElectricalautomation.h"

TElectricalAutomation::TElectricalAutomation(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::TElectricalAutomation)
{
    ui->setupUi(this);
...
TElectricalAutomation::~TElectricalAutomation()
{
    delete ui;
}

bool TElectricalAutomation::judgeEmpty()
{
...
void TElectricalAutomation::ShowSupplyclick()
{
...
void TElectricalAutomation::comeTeacherManage(QString num)
{
...
void TElectricalAutomation::on_searchbtn_clicked()
{
...
void TElectricalAutomation::on_addbtn_clicked()
{
    if(!this->judgeEmpty())
        return;
    _model->select();
...
void TElectricalAutomation::on_changebtn_clicked()
{
    if(model->submitAll())
...
void TElectricalAutomation::on_deletebtn_clicked()
{
...
void TElectricalAutomation::on_returnbtn_clicked()
{
    this->hide();
