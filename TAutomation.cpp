...
#include "ui_TAutomation.h"

TAutomation::TAutomation(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::TAutomation)
{
    ui->setupUi(this);
...
TAutomation::~TAutomation()
{
    delete ui;
}

bool TAutomation::judgeEmpty()
{
...
void TAutomation::ShowSupplyclick()
{
...
void TAutomation::comeTeacherManage(QString num)
{
...
void TAutomation::on_searchbtn_clicked()
{
...
void TAutomation::on_addbtn_clicked()
{
    if(!this->judgeEmpty())
        return;
    _model->select();
...
void TAutomation::on_changebtn_clicked()
{
    if(model->submitAll())
...
void TAutomation::on_deletebtn_clicked()
{
...
void TAutomation::on_returnbtn_clicked()
{
    this->hide();
