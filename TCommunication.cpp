...
#include "ui_TCommunication.h"

TCommunication::TCommunication(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::TCommunication)
{
    ui->setupUi(this);
...
bool TCommunication::judgeEmpty()
{
...
void TCommunication::ShowSupplyclick()
{
...
void TCommunication::comeTeacherManage(QString num)
{
...
void TCommunication::on_searchbtn_clicked()
{
...
void TCommunication::on_addbtn_clicked()
{
    if(!this->judgeEmpty())
        return;
    _model->select();
...
void TCommunication::on_changebtn_clicked()
{
    if(model->submitAll())
...
void TCommunication::on_deletebtn_clicked()
{
...
void TCommunication::on_returnbtn_clicked()
{
    this->hide();
